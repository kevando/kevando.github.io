...
var firebaseConfig = {
  apiKey: "AIzaSyDD_k2DcfFmKJCUwAvwFFXuuCoPzK5c3Ws",
  storageBucket: "gs://senate-6d105.appspot.com"
};
firebase.initializeApp(firebaseConfig);

var storage = firebase.storage();
var tomatoRef = storage.ref("tomato-7lc4vhi3o4.glb");
...
// // Returns a pipeline module that initializes the threejs scene when the camera feed starts, and
// // handles subsequent spawning of a glb model whenever the scene is tapped.
// const placegroundScenePipelineModulee = () => {
...
//     console.log('XR.8Threejs',XR.Threejs.xrScene())

//     // console.log('XR8.Threejs',XR8.Threejs)
//     const scale = Object.assign({}, startScale);
...
const onxrloaded = () => {
  ...
  // document.body.insertAdjacentHTML('beforeend', camerafeedHtml) // missing?
