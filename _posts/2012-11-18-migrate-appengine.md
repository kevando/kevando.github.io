---
layout: post
title:  Another Way to 'Migrate' your App Engine to the High Replication Datastore
date: 2012-11-18
categories: blog
tags:
  - tumblr
...
<pre>The 'python27' runtime is only supported for apps using the High Replication Datastore.</pre>
