...
function processData(values) {
  ...
  console.log(
    " removed: " + (old - airports.length) + " airports out of bounds"
  );
  ...
  console.log(
    " removed: " + (old - airports.length) + " airports with NA state"
  );
  ...
  console.log(
    " removed: " + (old - airports.length) + " airports without flights"
  );
  ...
  console.log(
    " removed: " +
      (old - airports.length) +
      " airports with low outgoing degree"
  );
...
function handleMouseOverState(d, i) {  // Add interactivity
  d3.select(this)
      .classed("active", true);

}

function handleMouseOutState(d, i) {  // Add interactivity
  d3.select(this)
