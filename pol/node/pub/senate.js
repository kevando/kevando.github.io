...
d3.json("/pol/node/pub/senate_og.json", function(classes) {
  ...
  var path = svg.selectAll("path.link")
    ...
    .enter().append("svg:path")
      .attr("class", function(d) {
        ...
        // console.log(sourceFollowsTarget);
        if(sourceFollowsTarget && targetFollowsSource) {
          // console.log('Friends!')
          relationshipClass = 'source-target-friends';
        } else if(targetFollowsSource) {
          // console.log('source only follows target!')
          relationshipClass = 'target-follows-source';
        }
        else if(sourceFollowsTarget) {
